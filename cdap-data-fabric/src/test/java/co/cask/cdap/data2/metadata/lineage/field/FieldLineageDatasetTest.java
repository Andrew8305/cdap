...
public class FieldLineageDatasetTest {
  ...
  public void testSimpleOperations() throws Exception {
    ...
    txnl.execute(() -> {
      ...
      Assert.assertEquals(programRunOperations.getChecksum(), info1.getChecksum());
      ...
      expectedSet.add(new ProgramRunOperations(info1.getChecksum(),
              Collections.singleton(programRun1), info1.getOperations()));
      expectedSet.add(new ProgramRunOperations(info2.getChecksum(),
              new HashSet<>(Arrays.asList(programRun2, programRun3)), info2.getOperations()));
